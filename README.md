...
- **Sense → Reason → Act → Learn** — proactive nudges between sessions, adaptive briefing format that learns your behavior, deterministic email signal extraction, cross-domain pattern alerts, async knowledge capture via `/remember`, and monthly retrospectives
