...
- **Career Search Intelligence** — 7-block A–G job evaluation framework, ATS-optimized PDF generation via Playwright, application tracker with story bank, 90-day audit trail, and 3 guardrails for JD injection, auto-submit prevention, and PII protection (`/career eval <URL>`)
