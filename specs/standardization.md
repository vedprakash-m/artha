...
| `scripts/parse_contacts.py` | Full phone numbers, emails for all 4 family members; VCF path `"Ved Mishra and 1,911 others.vcf"` | L14, L39, L381-384 | Remove example data; read from profile |
